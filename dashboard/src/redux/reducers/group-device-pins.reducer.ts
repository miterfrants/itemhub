...
export const groupDevicePinsSlice = createSlice({
    name: 'groupDevicePins',
...
export const groupDevicePinsActions = groupDevicePinsSlice.actions;

export const selectGroupDevicePins = (state: RootState) =>
    state.groupDevicePins;

export default groupDevicePinsSlice.reducer;
