...
export class HowToImplementPipelineComponent extends BaseComponent {
    constructor (elRoot, variable, args) {
        super(elRoot, variable, args);
        this.id = 'HowToImplementPipelineComponent';
    }
    ...
    sendGaEvent () {
        this.args.gtag('event', EVENTS.SIGN_UP_FROM_HOW_TO_IMPLEMENT_PIPELINE);
    }
}
