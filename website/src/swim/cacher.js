...
import {
    HowToImplementSmartAcComponent
} from '../components/how-to-implement-smart-ac/how-to-implement-smart-ac.component.js';
import HowToImplementSmartAcHTML from '../components/how-to-implement-smart-ac/how-to-implement-smart-ac.html';
import '../components/how-to-implement-smart-ac/how-to-implement-smart-ac.scss';

import {
    HowToImplementSolarPoweredWeatherStationComponent
} from '../components/how-to-implement-solar-powered-weather-station/how-to-implement-solar-powered-weather-station.component.js';
import HowToImplementSolarPoweredWeatherStationHTML from '../components/how-to-implement-solar-powered-weather-station/how-to-implement-solar-powered-weather-station.html';
import '../components/how-to-implement-solar-powered-weather-station/how-to-implement-solar-powered-weather-station.scss';
...
import featureAutomationHTML from '../template/feature-automation.html';

import featureEasyConnectivityHTML from '../template/feature-easy-connectivity.html';

import featureSecurityHTML from '../template/feature-security.html';

import featureHTML from '../template/feature.html';
...
import solutionHTML from '../template/solution.html';
...
export const Cacher = {
    buildCache: () => {
        ...
        window.SwimAppStylesheet.push(`${APP_CONFIG.FRONT_END_PREFIX}/components/how-to-implement-smart-ac/how-to-implement-smart-ac.css`);
        window.SwimAppComponents.HowToImplementSmartAcComponent = HowToImplementSmartAcComponent;
        window.SwimAppLoaderCache[`${APP_CONFIG.FRONT_END_PREFIX}/components/how-to-implement-smart-ac/how-to-implement-smart-ac.html`] = HowToImplementSmartAcHTML;
        window.SwimAppStylesheet.push(`${APP_CONFIG.FRONT_END_PREFIX}/components/how-to-implement-solar-powered-weather-station/how-to-implement-solar-powered-weather-station.css`);
        window.SwimAppComponents.HowToImplementSolarPoweredWeatherStationComponent = HowToImplementSolarPoweredWeatherStationComponent;
        window.SwimAppLoaderCache[`${APP_CONFIG.FRONT_END_PREFIX}/components/how-to-implement-solar-powered-weather-station/how-to-implement-solar-powered-weather-station.html`] = HowToImplementSolarPoweredWeatherStationHTML;
        ...
        window.SwimAppLoaderCache[`${APP_CONFIG.FRONT_END_PREFIX}/template/feature-automation.html`] = featureAutomationHTML;
        window.SwimAppLoaderCache[`${APP_CONFIG.FRONT_END_PREFIX}/template/feature-easy-connectivity.html`] = featureEasyConnectivityHTML;
        window.SwimAppLoaderCache[`${APP_CONFIG.FRONT_END_PREFIX}/template/feature-security.html`] = featureSecurityHTML;
        window.SwimAppLoaderCache[`${APP_CONFIG.FRONT_END_PREFIX}/template/feature.html`] = featureHTML;
        ...
        window.SwimAppLoaderCache[`${APP_CONFIG.FRONT_END_PREFIX}/template/solution.html`] = solutionHTML;
