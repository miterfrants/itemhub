    ...
    public static class RestorePrevisousStateService
    {
            ...
            )
        {
            ...
            pipelines.ForEach(pipeline =>
            {
                ...
                PipelineHelper.Execute(serverId, pipeline.Id, pipelineItems, pipelineConnectors, iotDbContext, pipeline.OwnerId, isVIP, localMqttPublishers, mqttUsername, mqttPassword, smsUsername, smsPassword, smsClientUrl, sendGridApiKey, staticPath, systemEmail, dbc);
            });
        }
    }
}
