...
namespace IotApi.Migrations
{
    ...
    [Migration("20230625140919_AddDevicePinTypeDefaultValue")]
    partial class AddDevicePinTypeDefaultValue
    {
            ...
            modelBuilder.Entity("Homo.IotApi.DeviceUploadedImage", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 6, 25, 22, 9, 19, 150, DateTimeKind.Local).AddTicks(7850));
            ...
            modelBuilder.Entity("Homo.IotApi.PipelineExecuteLog", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 6, 25, 22, 9, 19, 149, DateTimeKind.Local).AddTicks(3200));
