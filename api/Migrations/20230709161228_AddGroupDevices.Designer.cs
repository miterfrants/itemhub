...
namespace IotApi.Migrations
{
    ...
    [Migration("20230709161228_AddGroupDevices")]
    partial class AddGroupDevices
    {
            ...
            modelBuilder.Entity("Homo.IotApi.DeviceUploadedImage", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 7, 10, 0, 12, 28, 556, DateTimeKind.Local).AddTicks(8350));
            ...
            modelBuilder.Entity("Homo.IotApi.PipelineExecuteLog", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 7, 10, 0, 12, 28, 556, DateTimeKind.Local).AddTicks(6940));
