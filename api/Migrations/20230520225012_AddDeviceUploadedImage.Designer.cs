...
namespace IotApi.Migrations
{
    ...
    [Migration("20230520225012_AddDeviceUploadedImage")]
    partial class AddDeviceUploadedImage
    {
            ...
            modelBuilder.Entity("Homo.IotApi.DeviceUploadedImage", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 5, 21, 6, 50, 12, 17, DateTimeKind.Local).AddTicks(310));
            ...
            modelBuilder.Entity("Homo.IotApi.PipelineExecuteLog", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 5, 21, 6, 50, 12, 16, DateTimeKind.Local).AddTicks(8730));
