...
namespace IotApi.Migrations
{
    ...
    [Migration("20231112140200_MigratePipelineTypeLog")]
    partial class MigratePipelineTypeLog
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Homo.IotApi.ComputedFunction", b =>
                {
                    ...
                    b.HasIndex("UserId", "IsGroup", "DeviceId", "Pin", "Target", "IsDeleted")
                        .IsUnique();
            ...
            modelBuilder.Entity("Homo.IotApi.PipelineExecuteLog", b =>
                {
                    b.HasOne("Homo.IotApi.PipelineItem", "Item")
                        .WithMany()
